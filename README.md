...
(TRUE, 'TINT-+5841', 'Toga y Birrete', 0.0, 14.00, 19.60, 15),
...
(TRUE, 'García Pérez', 'V-12345678', 'Caracas', '1010', 'm.garcia@email.com', 'María Elena', 'Venezuela', 'Distrito Capital', '+584141234567', '+582129876543', 'Las Mercedes'),
(TRUE, 'Rodríguez Silva', 'V-18765432', 'Valencia', '2001', 'carlos.rodriguez@email.com', 'Carlos Eduardo', 'Venezuela', 'Carabobo', '+584245678901', '+582128234567', 'El Trigal'),
(TRUE, 'Fernández López', 'V-14567890', 'Barquisimeto', '3001', 'ana.fernandez@email.com', 'Ana Sofía', 'Venezuela', 'Lara', '+584123456789', '+582122534567', 'Nueva Segovia'),
(TRUE, 'Martínez Castro', 'V-19876543', 'Maracaibo', '4001', 'luis.martinez@email.com', 'Luis Alberto', 'Venezuela', 'Zulia', '+584167890123', '+582127894561', 'Bella Vista'),
(TRUE, 'Gómez Hernández', 'V-11223344', 'Maracay', '2101', 'patricia.gomez@email.com', 'Patricia', 'Venezuela', 'Aragua', '+584149876543', '+582122345678', 'Base Aragua'),
(TRUE, 'Pérez Morales', 'V-16543210', 'Mérida', '5101', 'jorge.perez@email.com', 'Jorge Antonio', 'Venezuela', 'Mérida', '04261234567', '+582122445566', 'La Parroquia'),
(TRUE, 'Sánchez Torres', 'V-20123456', 'San Cristóbal', '5001', 'andrea.sanchez@email.com', 'Andrea', 'Venezuela', 'Táchira', '+584147654321', '+582123432100', 'Pueblo Nuevo'),
(TRUE, 'Díaz Romero', 'V-15987654', 'Puerto La Cruz', '6023', 'roberto.diaz@email.com', 'Roberto José', 'Venezuela', 'Anzoátegui', '+584248765432', '+582122678901', 'Lechería'),
(TRUE, 'Álvarez Mendoza', 'V-13456789', 'Maturín', '6201', 'gabriela.alvarez@email.com', 'Gabriela', 'Venezuela', 'Monagas', '+584129876543', '+582126421122', 'Tipuro'),
(TRUE, 'Torres Ruiz', 'V-17890123', 'Barinas', '5201', 'daniel.torres@email.com', 'Daniel Alejandro', 'Venezuela', 'Barinas', '+584161234567', '+582125321144', 'Alto Barinas'),
(TRUE, 'Ramírez Flores', 'E-82123456', 'Caracas', '1060', 'john.smith@email.com', 'John', 'Venezuela', 'Distrito Capital', '+584141112233', '+582122854321', 'Los Palos Grandes'),
(TRUE, 'Benítez Vargas', 'V-21345678', 'Ciudad Guayana', '8015', 'sofia.benitez@email.com', 'Sofía Victoria', 'Venezuela', 'Bolívar', '+584249012345', '+582129234567', 'Alta Vista'),
(TRUE, 'Vargas Medina', 'V-10987654', 'Punto Fijo', '4102', 'manuel.vargas@email.com', 'Manuel Enrique', 'Venezuela', 'Falcón', '+584123334455', '+582122468013', 'Puerta Maraven'),
(TRUE, 'Castillo Gutiérrez', 'V-22456789', 'Los Teques', '1201', 'valentina.castillo@email.com', 'Valentina', 'Venezuela', 'Miranda', '+584145556677', '+582123214567', 'San Antonio'),
(TRUE, 'Rojas Navarro', 'V-16789012', 'Acarigua', '3301', 'fernando.rojas@email.com', 'Fernando', 'Venezuela', 'Portuguesa', '+584247778899', '+582126213456', 'Araure'),
(TRUE, 'Mendoza Acosta', 'V-19012345', 'Cumaná', '6101', 'camila.mendoza@email.com', 'Camila Isabel', 'Venezuela', 'Sucre', '+584168889900', '+582124312233', 'San Gonzalo'),
(TRUE, 'Silva Reyes', 'E-84567890', 'Caracas', '1080', 'pierre.dubois@email.com', 'Pierre', 'Venezuela', 'Distrito Capital', '+584124445566', '+582129912233', 'La Castellana'),
(TRUE, 'Guerrero Parra', 'V-15432109', 'Margarita', '6301', 'diego.guerrero@email.com', 'Diego Armando', 'Venezuela', 'Nueva Esparta', '+584146667788', '+582122623344', 'Pampaatar'),
(TRUE, 'Ortiz Molina', 'V-23123456', 'San Felipe', '3201', 'natalia.ortiz@email.com', 'Natalia', 'Venezuela', 'Yaracuy', '+584242223344', '+582122314455', 'Independencia'),
(TRUE, 'Delgado Rivas', 'J-301234560', 'Valencia', '2003', 'contacto@delgadorivas.com', 'Corporación Delgado', 'Venezuela', 'Carabobo', '+584121110099', '+582128520011', 'Zona Industrial');